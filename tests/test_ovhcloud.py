...
class TestInventoryStoragePrices:
    ...
    def test_hourly_pricing_conversion(self, mock_get_storages):
        ...
        expected_monthly_price = (13200 * HOURS_PER_MONTH) / MICROCENTS_PER_CURRENCY_UNIT
            ...
            'plans': [
                {
                    ...
                    'addonFamilies': [
                        {
                            'name': 'storage',
                            'addons': ['storage.consumption']
                        },
                        {
                            'name': 'volume',
                            'addons': ['volume.high-speed.consumption']
                        }
                    ]
                }
            ],
