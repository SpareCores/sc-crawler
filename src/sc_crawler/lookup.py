...
benchmarks: List[Benchmark] = [
    ...
    Benchmark(
        ...
        category="Database",
        description="HammerDB TPC-H on a remote client VM against Postgres on the DB host (multi-VM topology). Score is QphH at adaptive peak concurrency.",
        framework="hammerdb_postgres_multi",
        measurement="qphh",
        config_fields={
            "topology": "Deployment topology (multi_vm).",
    ...
    Benchmark(
        ...
        category="Database",
        description="BenchBase workloads (wikipedia, ycsb, …) on a remote client VM against Postgres on the DB host (multi-VM topology). Score is peak TPM at adaptive peak concurrency.",
