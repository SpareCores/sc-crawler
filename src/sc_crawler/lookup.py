...
benchmarks: List[Benchmark] = [
    ...
    Benchmark(
        ...
        description="Average round-trip transit time (ns) between CPU and individual GPUs utilizing CE (Copy Engine).",
        framework="nvbandwidth",
