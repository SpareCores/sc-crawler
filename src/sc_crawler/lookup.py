...
benchmarks: List[Benchmark] = [
    ...
    Benchmark(
        ...
        name="BenchBase Postgres read-heavy (multi-VM)",
        category="Database",
        description="BenchBase wikipedia workload on a remote client VM against Postgres on the DB host (multi-VM topology). Score is peak TPM at adaptive peak concurrency.",
