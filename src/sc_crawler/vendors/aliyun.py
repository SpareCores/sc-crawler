...
def get_instance_types():
    """
    Gathers the available ECS instance types available in the given region. Uses the standard client object generated by the "get_client" function. Returns a list.
    """
    client = get_client()
...
def inventory_server_prices(vendor):
    ...
    NOTE: The database structure had a mandatory zone field, which is populated with the first (a) zone of each region, but all zones have the same ECS availability in a region. 
    """
